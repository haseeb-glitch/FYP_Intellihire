...
export default function Navbar() {
  ...
  /* ─── Logo animation: flies from hero center into navbar ─── */
  ...
  /* ─── Navbar background: transparent → glassmorphism → transparent ─── */
  ...
  /* ─── Text colors: white on hero → navy on light → white on black ─── */
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ padding: '22px 52px', maxWidth: '1800px', margin: '0 auto' }}
        >

          {/* ═══════════ LEFT: 3 Navigation Links ═══════════ */}
          ...
          {/* ═══════════ CENTER: INTELLIHIRE (absolute positioned) ═══════════ */}
          <div
          ...
          <div className="hidden md:block flex-shrink-0">
            <a href="/signup" className="ih-cta">
              Get Started
            </a>
          </div>
