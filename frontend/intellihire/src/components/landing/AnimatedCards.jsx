...
export default function AnimatedCards() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const sc = { x: heroRect.left + heroRect.width / 2 - CW / 2, y: heroRect.top + heroRect.height / 2 - CH / 2 };
  ...
  return (
    <>
      <style>{`
        ...
        .card.landed { position: absolute; pointer-events: auto; transition: box-shadow 0.3s; }
        .card.landed:hover { box-shadow: 0 40px 100px rgba(30,90,160,0.3); transform: translateY(-4px) !important; transition: box-shadow 0.3s, transform 0.3s; }
        ...
        .clabel { position: absolute; bottom: -50px; left: 0; opacity: 0; transition: opacity 0.5s ease; }
      ...
      <div ref={cardRefs[0]} className="card" id="c1">
        <div className="ci">
          <div className="cam"><img src="/Feature-cards/cards1.jpeg" alt="" /><div className="cam-ov"></div></div>
      ...
      <div ref={cardRefs[1]} className="card" id="c2">
        <div className="ci">
          <div className="cam"><img src="/Feature-cards/cards2.jpeg" alt="" /><div className="cam-ov"></div></div>
      ...
      <div ref={cardRefs[3]} className="card" id="c4">
        <div className="ci">
          <div className="cam"><img src="/Feature-cards/cards3.jpeg" alt="" /><div className="cam-ov"></div></div>
