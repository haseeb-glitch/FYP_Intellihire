...
const UdemyLogo = () => (
  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="18" y="25" fontFamily="Georgia, serif" fontSize="22" fontWeight="bold" fill="#EC5252" textAnchor="middle" fontStyle="italic">U</text>
    </svg>
    <span style={{ fontFamily: "'Georgia', serif", fontSize: "22px", fontWeight: "600", color: "#333", letterSpacing: "-0.3px" }}>Udemy</span>
  </div>
);
...
const GarnierLogo = () => (
  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
    ...
    <span style={{ fontFamily: "'Arial Narrow', 'Arial', sans-serif", fontSize: "20px", fontWeight: "500", color: "#888", letterSpacing: "4px", textTransform: "uppercase" }}>GARNIER</span>
  </div>
);
...
const SlackLogo = () => (
  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
    ...
    <span style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", fontSize: "26px", fontWeight: "700", color: "#1D1C1D", letterSpacing: "-0.5px" }}>slack</span>
  </div>
);
...
function LogoItem({ children }) {
  return (
    <div style={{ display: "inline-flex", alignItems: "center", padding: "0 60px", flexShrink: 0 }}>
      {children}
    </div>
  );
}
...
export default function LogoMarquee() {
  ...
  return (
    <div ref={containerRef} style={{ width: "100%", backgroundColor: "transparent", overflow: "hidden", position: "relative", padding: "40px 0" }}>
      <div ref={trackRef} style={{ display: "flex", alignItems: "center", willChange: "transform", whiteSpace: "nowrap" }}>
        {allLogos.map((logo, i) => (
          <LogoItem key={`${logo.id}-${i}`}>{logo.component}</LogoItem>
        ))}
      </div>
    </div>
  );
